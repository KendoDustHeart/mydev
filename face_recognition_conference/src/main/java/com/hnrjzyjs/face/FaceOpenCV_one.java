...
public class FaceOpenCV_one extends JPanel {
        ...
        public static Mat detectFace(Mat img) {
            ...
            CascadeClassifier faceDetector = new CascadeClassifier("D:\\Sofeware\\opencv\\sources\\data\\haarcascades\\haarcascade_frontalface_alt.xml");
            CascadeClassifier eyeDetector = new CascadeClassifier("D:\\Sofeware\\opencv\\sources\\data\\haarcascades\\haarcascade_eye.xml");
...
//                        new Scalar(0, 0, 255), 2);
                    ...
                    if( eyesDetections.toArray().length > 1){
                        save(img, rect, "Pictures/"+r.nextInt(2000)+".jpg");
                    }
        ...
        public static void main(String[] args) {
            try{
                ...
                FaceOpenCV_one panel = new FaceOpenCV_one();
